...
class ApiClient {
    ...
    private async request<T = any>(
        ...
        try {
            ...
            try {
                ...
                console.log('API Response data:', { success: data.success, hasData: !!data.data, hasToken: !!data.token });
    ...
    async login(email: string, password: string) {
        console.log('API: Attempting login with:', { email, baseURL: this.baseURL });
        return this.request<{
            id: string;
            name: string;
            email: string;
